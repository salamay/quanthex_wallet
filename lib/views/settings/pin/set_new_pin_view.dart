...
class SetNewPinView extends StatefulWidget {
  ...
  @override
  State<SetNewPinView> createState() => _SetNewPinViewState();
}

class _SetNewPinViewState extends State<SetNewPinView> {
  String _pin = '';
  ...
  Future<void> _savePin() async {
    try {
      ...
      showMySnackBar(context: context, message: "PIN changed successfully", type: SnackBarType.success);
      // Navigate back to security privacy view
      Navigate.back(context);
      Navigate.back(context); // Go back twice: SetNewPinView -> VerifyCurrentPinView -> SecurityPrivacyView
    } catch (e) {
      context.loaderOverlay.hide();
      logger("Error saving PIN: $e", runtimeType.toString());
      showMySnackBar(context: context, message: "Error saving PIN", type: SnackBarType.error);
    }
  }
