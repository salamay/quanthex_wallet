...
class StakingSuccessModal extends StatelessWidget {
  final StakingPayload stake;
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              15.horizontalSpace,
              Text(
                '-${stake.stakedAmountCrypto} ${token.symbol}',
                style: TextStyle(
          ...
          RichText(
            ...
            text: TextSpan(
              ...
              children: [
                ...
                TextSpan(
                  text: '${stake.stakedAmountCrypto} ${token.symbol}',
                  style: TextStyle(
                    color: const Color(0xFF792A90),
                    fontWeight: FontWeight.w700,
                  ),
