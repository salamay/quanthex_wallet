                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            border: Border.all(
                              color:  rewardCoin==null? const Color(0xFFE0E0E0) : const Color(0xFF792A90),
                              width: 1,
                            ),
                          ),
                          child: Row(
                              ...
                              Expanded(
                                child: Row(
                                  children: [
                                    ...
                                    Expanded(
                                      child: Text(
                                        rewardCoin==null? 'Choose your preferred payout currency'
                                            : "${rewardCoin!.symbol} - (${rewardCoin!.networkModel!.chainSymbol.toUpperCase()})",
                                        style: TextStyle(
                                          color: rewardCoin==null ? const Color(0xFF9E9E9E) : const Color(0xFF2D2D2D),
                                          fontSize: 16.sp,
                                          fontFamily: 'Satoshi',
                                          fontWeight: FontWeight.w500,
                                        ),
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                ...
                                balance!=null?Text(
                                  'Balance: ${!bCtr.hideBalance?balance.balanceInCrypto!=0?"${MyCurrencyUtils.format(balance.balanceInCrypto,pToken.coinType==CoinType.TOKEN?2:6)??""} ${pToken.symbol}":"0 ${pToken.symbol}":"****" }',
                                  style: TextStyle(
                                    color: const Color(0xFF757575),
                                    fontSize: 14.sp,
                                    fontFamily: 'Satoshi',
                                ...
                                GestureDetector(
                                  ...
                                  child: Container(
                                    ...
                                    child: Row(
                                      children: [
                                        CoinImage(
                                          imageUrl: widget.paymentToken.image,
                                          width: 32.sp,
                                          height: 32.sp,),
                                        10.horizontalSpace,
                                        Text(
