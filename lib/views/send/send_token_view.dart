...
class _SendTokenViewState extends State<SendTokenView> {
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            Consumer<BalanceController>(
                                ...
                                return balance!=null?Text(
                                  'Balance: ${ !bCtr.hideBalance?balance.balanceInCrypto!=0?"${MyCurrencyUtils.format(balance.balanceInCrypto,_selectedCoin.coinType==CoinType.TOKEN?2:6)??""} ${_selectedCoin.symbol}":"0 ${_selectedCoin.symbol}":"****"}',
                                  style: TextStyle(
                                    color: const Color(0xFF757575),
                                    fontSize: 14.sp,
                                    fontFamily: 'Satoshi',
                        ...
                        Row(
                          children: [
                            ...
                            Consumer<BalanceController>(
                                builder: (context, bCtr, child) {
                                double? priceQuotes=bCtr.priceQuotes[_selectedCoin.symbol];
                                return priceQuotes!=null?Expanded(
                                  child: TextField(
                        ...
                        Align(
                          ...
                          child: Text(
                            _amountInFiat > 0
                                ? '\$${MyCurrencyUtils.format(_amountInFiat,_selectedCoin.coinType==CoinType.TOKEN?2:6)}'
                                : '',
                            style: TextStyle(
  ...
  Future<void> send({required BuildContext context}) async {
    ...
    try{
      ...
      hideOverlay(context);
      _showConfirmTransaction(context);
